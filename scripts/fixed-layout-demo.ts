 ...
 *
 *   bun run scripts/fixed-layout-demo.ts             # streams synthetic output at you
 *   bun run scripts/fixed-layout-demo.ts --file X    # loads a real file instead
 *   bun run scripts/fixed-layout-demo.ts --quiet     # no streaming; static content
 */
