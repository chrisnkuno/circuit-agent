...
**92/100 (excellent)** · 6/6 live journeys · 3,117 control tests · 0 failures

Latest run: 2026-08-29 on `cohere/north-mini-code:free`. 4.2% tool failure rate · 0% provider failure rate · 100% output-quality checks · 85,819 tokens · 3/3 operating systems. Daily benchmark: code build, responsive web build, debug, scoped search, Defender review, cross-process resume, UI, memory, security, approvals, cost accounting, Exa research, and portability. [Machine-readable evidence](reliability/latest.json).
