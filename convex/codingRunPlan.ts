...
export type StartCodingRunResult = { taskId: Id<"tasks">; runId: Id<"agentRuns"> };
...
export async function startCodingRun(
  ctx: ActionCtx,
  args: { organizationId: Id<"organizations">; objective: string; idempotencyKey: string; authorization: "session" | "trusted-organization" },
